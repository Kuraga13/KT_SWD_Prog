 ...
 * @brief          : Flash driver for STM32U5 series
 * @author         : Kuraga Team
 ******************************************************************************
 * @attention
 *
 ...
 * @details
 *
 * Flash driver for STM32U5 series (Cortex-M33, ultra-low-power, TrustZone).
 * Page-based flash with quad-word (128-bit = 16 bytes) programming.
 *
 * Features:
 * - Page erase (8 KB) and mass erase
 ...
 * Usage Example:
 * ```cpp
 * Stm32U5FlashDriver flash_driver;
...
namespace stm32u5_flash {
    ...
    constexpr uint32_t CR_PNB_MASK      = 0xFF;
    ...
    // Programming width: quad-word = 16 bytes
...
class Stm32U5FlashDriver : public FlashDriver {
public:
