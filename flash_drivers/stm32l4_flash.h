/**
 ******************************************************************************
 * @file           : stm32l4_flash.h
 * @brief          : Flash driver for STM32L4 series
 * @author         : Kuraga Team
 ******************************************************************************
 * @attention
 *
 ...
 * @details
 *
 * Flash driver for STM32L4 series (Cortex-M4F, low-power).
 * Page-based flash with double-word (64-bit) programming.
 * Same flash controller family as G0/G4/L5.
 *
 * Features:
 * - Page erase (2 KB) and mass erase
 * - Double-word (64-bit) flash programming
 * - Dual-bank support on L4+ variants
 * - Option byte read/write with RDP, WRP, PCROP support
 * - OTP area access
 *
 * Usage Example:
 * ```cpp
 * Stm32L4FlashDriver flash_driver;
...
class Stm32L4FlashDriver : public FlashDriver {
public:
