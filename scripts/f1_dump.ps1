# ==============================================================================
#  STM32F1 full dump script (PowerShell)
#  Reads: flash (auto-detected size), option bytes (16 B), RDP level
#  Output: dumps\f1\ directory
# ==============================================================================
...
if (-not $OutDir) { $OutDir = Join-Path $ScriptDir "..\dumps\f1" }
...
Write-Host "=== STM32F1 Full Dump ===" -ForegroundColor Cyan
Write-Host ""
...
# Read flash size register (0x1FFFF7E0, 16-bit value in KB)
