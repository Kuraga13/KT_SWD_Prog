# ==============================================================================
#  STM32G0 full dump script (PowerShell)
#  Reads: flash (auto-detected size), option bytes (28 B), OTP (1 KB), RDP level
#  Output: dumps\g0\ directory
# ==============================================================================
...
if (-not $OutDir) { $OutDir = Join-Path $ScriptDir "..\dumps\g0" }
...
Write-Host "=== STM32G0 Full Dump ===" -ForegroundColor Cyan
Write-Host ""
...
# Read flash size register (0x1FFF75E0, 16-bit value in KB)
...
Write-Host "[5/7] Reading option bytes (28 bytes at 0x40022020)..." -ForegroundColor Yellow
Invoke-CLI "read", "ob", "0x40022020", "0x1C", "-o", (Join-Path $OutDir "optionbytes.bin")
Write-Host ""

Write-Host "[6/7] Reading OTP (1 KB at 0x1FFF7000)..." -ForegroundColor Yellow
Invoke-CLI "read", "otp", "0x1FFF7000", "0x400", "-o", (Join-Path $OutDir "otp.bin")
Write-Host ""
